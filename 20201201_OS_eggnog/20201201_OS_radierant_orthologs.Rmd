...
# mydb_7091 <- mydb %>% filter(Taxon=="7091")
 ...
 /rugpfs/fs0/brc/scratch/mpaul/1_kronauer/orli/Kronauer_Orli/20201201_OS_eggnog/eggnogAnno_CondaVersionPy2_Scopeis50557_Targetis7091_FAisObiroi
 /rugpfs/fs0/brc/scratch/mpaul/1_kronauer/orli/Kronauer_Orli/20201201_OS_eggnog/eggnogAnno_CondaVersionPy2_Scopeis50557_Targetis2015173_FAisBmori
 /rugpfs/fs0/brc/scratch/mpaul/1_kronauer/orli/Kronauer_Orli/20201201_OS_eggnog/eggnogAnno_CondaVersionPy2_Scopeis50557_Targetis7227_FAisBmori
 /rugpfs/fs0/brc/scratch/mpaul/1_kronauer/orli/Kronauer_Orli/20201201_OS_eggnog/eggnogAnno_CondaVersionPy2_Scopeis50557_Targetis7227_FAisObiroi

queryName <- dir(".", pattern="FAisObiroi.emapper.annotations") %>% str_split("FAis", simplify=T) %>% .[,2] %>% str_split(".emapp", simplify=T) %>% .[,1]
answerID <- dir(".", pattern="FAisObiroi.emapper.annotations") %>% str_split("Targetis", simplify=T) %>% .[,2] %>% str_split("_FA", simplify=T) %>% .[,1] 
